...
class Test(unittest.TestCase):                                              #Clase Test que hereda de unittest.TestCase
    ...
    def test_position(self):                                                #Método de proba tomando self como parámetro. Vaise comprobar cal e o quinto numero da secuencia de Fibonacci
        list_result = fibonacci(5)                                          #Chamada ao metodo fibonacci co argumento 5 e gardalo na lista list_result
